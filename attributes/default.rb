...
default['smartsense-chef']['java_home'] = "/usr/lib/jvm/java-#{node[:java][:jdk_version]}-#{node[:java][:install_flavor]}-amd64" 
default['smartsense-chef']['cluster_name'] = node.chef_environment
